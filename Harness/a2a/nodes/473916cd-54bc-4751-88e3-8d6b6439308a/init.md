...
- Session: 473916cd-54bc-4751-88e3-8d6b6439308a
- Runtime: claude
- Agent kind: main
- Role: Main Agent
- Display name: ceo
...
- Role profile: Harness/a2a/agent-roles/session-e216560a-5e95-453d-9b66-cfc5a6238671.md — read this file; it is your identity and mandate.
- Workflow mode: /wf
...
- Node home: Harness/a2a/nodes/473916cd-54bc-4751-88e3-8d6b6439308a
- Env node init: HARNESS_NODE_INIT=
- Env session id: HARNESS_PEER_SESSION_ID=473916cd-54bc-4751-88e3-8d6b6439308a
