...
- Session: 8db0ffb5-d5af-48cd-84b9-d4d84238981a | Runtime: claude | Graph node: session-5f9a256c-005b-4ba4-86ae-df4be75c33fb
- Subagent mode: built-in-subagents | Workflow mode: /wf
- Node home: Harness/a2a/nodes/8db0ffb5-d5af-48cd-84b9-d4d84238981a | This file: Harness/a2a/nodes/8db0ffb5-d5af-48cd-84b9-d4d84238981a/init.md
- Display name: ceo
- Role title: ceo
...
- Env subagent mode: HARNESS_SUBAGENT_MODE=built-in-subagents | Env: HARNESS_NODE_INIT= | HARNESS_PEER_SESSION_ID=8db0ffb5-d5af-48cd-84b9-d4d84238981a | HARNESS_WORKFLOW_NODE_ID=session-5f9a256c-005b-4ba4-86ae-df4be75c33fb
