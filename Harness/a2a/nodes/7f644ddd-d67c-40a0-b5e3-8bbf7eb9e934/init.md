...
- Session: 7f644ddd-d67c-40a0-b5e3-8bbf7eb9e934
- Runtime: claude
- Agent kind: main
- Role: Main Agent
- Workflow mode: /wf
...
- Node home: Harness/a2a/nodes/7f644ddd-d67c-40a0-b5e3-8bbf7eb9e934
- Env node init: HARNESS_NODE_INIT=
- Env session id: HARNESS_PEER_SESSION_ID=7f644ddd-d67c-40a0-b5e3-8bbf7eb9e934
