...
- Session: 9d8d973a-af2e-40e5-a8ae-db65a8605187
- Runtime: claude
- Agent kind: main
- Role: Main Agent
- Workflow mode: /wf
...
- Node home: Harness/a2a/nodes/9d8d973a-af2e-40e5-a8ae-db65a8605187
- Env node init: HARNESS_NODE_INIT=
- Env session id: HARNESS_PEER_SESSION_ID=9d8d973a-af2e-40e5-a8ae-db65a8605187
...
- Treat this file plus Harness environment variables as your node identity. A short bootstrap prompt may also ask you to read HARNESS_NODE_INIT before acting.
