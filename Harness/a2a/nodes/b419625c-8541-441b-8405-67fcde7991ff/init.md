...
## Identity
- You are: implementer (implementer); Agent kind: subagent
- Session: b419625c-8541-441b-8405-67fcde7991ff | Runtime: claude | Graph node: session-a09d551d-6962-4826-9467-ecf3a6199534
- Subagent mode: built-in-subagents | Workflow mode: /wf
- Node home: Harness/a2a/nodes/b419625c-8541-441b-8405-67fcde7991ff | This file: Harness/a2a/nodes/b419625c-8541-441b-8405-67fcde7991ff/init.md
- Display name: implementer
- Role title: implementer
- Responsibility: e2e depth-gate probe
- Capabilities: terminal
- Role profile: Harness/a2a/agent-roles/session-a09d551d-6962-4826-9467-ecf3a6199534.md — read this file; it is your identity and mandate.
- Objective: e2e depth-gate probe
- Env subagent mode: HARNESS_SUBAGENT_MODE=built-in-subagents | Env: HARNESS_NODE_INIT= | HARNESS_PEER_SESSION_ID=b419625c-8541-441b-8405-67fcde7991ff | HARNESS_WORKFLOW_NODE_ID=session-a09d551d-6962-4826-9467-ecf3a6199534
