...
- Session: 261d2ed6-9682-4f74-9b9a-9834743299ac
- Runtime: claude
- Agent kind: main
- Role: Main Agent
- Display name: ceo
...
- Role profile: Harness/a2a/agent-roles/session-77e19cae-fa66-4458-bc0a-47ef085138a6.md — read this file; it is your identity and mandate.
- Workflow mode: /wf
...
- Node home: Harness/a2a/nodes/261d2ed6-9682-4f74-9b9a-9834743299ac
- Env node init: HARNESS_NODE_INIT=
- Env session id: HARNESS_PEER_SESSION_ID=261d2ed6-9682-4f74-9b9a-9834743299ac
