...
- Session: fcba87df-ebad-4b19-a7e9-efb6e6696f27
- Runtime: claude
- Agent kind: main
- Role: Main Agent
- Workflow mode: /wf
...
- Node home: Harness/a2a/nodes/fcba87df-ebad-4b19-a7e9-efb6e6696f27
- Env node init: HARNESS_NODE_INIT=
- Env session id: HARNESS_PEER_SESSION_ID=fcba87df-ebad-4b19-a7e9-efb6e6696f27
